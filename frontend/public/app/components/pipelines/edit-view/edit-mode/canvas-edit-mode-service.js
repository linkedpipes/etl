((definition) => {
    ...
    function getComponentMenuDom() {
        if (dom.componentMenu === undefined) {
            dom.componentMenu = jQuery("#componentMenu");
        }
        return dom.componentMenu;
    }

    function getComponentMenuMappingDom() {
        if (dom.mapping === undefined) {
            dom.mapping = jQuery("#mapping");
        }
        return dom.mapping;
    }

    function getComponentMenuExecuteDom() {
        if (dom.execute === undefined) {
            dom.execute = jQuery("#execute");
        }
        return dom.execute;
    }

    function getBlankMenuDom() {
        if (dom.blankMenu === undefined) {
            dom.blankMenu = jQuery("#blankMenu");
        }
        return dom.blankMenu;
    }
    ...
    function bind(_canvas, _api) {
        ...
        dom.componentMenu = undefined;
        dom.mapping = undefined;
        dom.execute = undefined;
        dom.canvas = undefined;
        dom.blankMenu = undefined;
    }
