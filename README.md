...
- [Docker Compose](https://docs.docker.com/compose/) is optional as `docker compose` is supported by modern versions of [Docker](https://www.docker.com/) 

### For building locally

- [Java](http://www.oracle.com/technetwork/java/javase/downloads/index.html) 21 LTS, 22, 23, 25 LTS, 26
...
docker compose up
```
This would use pre-build images stored at [GitHub Packages](https://github.com/orgs/linkedpipes/packages).
...
Note that it is also possible to use [Bash on Ubuntu on Windows](https://msdn.microsoft.com/en-us/commandline/wsl/about) or [Cygwin](https://www.cygwin.com/) and proceed as with Linux.
