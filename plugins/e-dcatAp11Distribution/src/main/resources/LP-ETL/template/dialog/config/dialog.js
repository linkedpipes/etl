define([], function () {
    ...
    const DESC = {
        "$namespace": "http://etl.linkedpipes.com/resource/components/e-dcatAp11Distribution/",
        "$type": "Configuration",
        "$options": {
            "$predicate": "auto",
            "$control": "auto"
        },
        "getDatasetIRIFromInput": {
            "$type": "bool",
            "$label": "Get dataset IRI from input"
        },
        "datasetIRI": {
            "$type": "str",
            "$label": "Dataset IRI"
        ...
        "genDistroIRI": {
            "$type": "bool",
            "$label": "Generate distribution IRI from dataset IRI"
        },
        "accessURLs": {
            "$type": "value",
            "$array": true,
        ...
        "documentationIRIs": {
            "$type": "value",
            "$array": true,
            "$label": "Documentation IRIs"
        },
        "languagesFromDataset": {
            "$type": "bool",
        ...
        "issuedFromDataset": {
            "$type": "bool",
            "$label": "Use release date from dataset"
        },
        "issued": {
            "$type": "date",
            "$label": "Release date"
        ...
        "modifiedFromDataset": {
            "$type": "bool",
            "$label": "Use modified date from dataset"
        },
        "modifiedNow": {
            "$type": "bool",
        ...
        "checksum": {
            "$type": "str",
            "$label": "SHA-1 checksum"
        },
        "spatialIRIs": {
            "$type": "value",
            "$array": true,
            "$label": "Spatial coverage IRIs"
        },
        "temporalStart": {
            "$type": "date",
            "$label": "Temp. cov. start"
        },
        "temporalEnd": {
            "$type": "date",
            "$label": "Temp. cov. end"
    ...
    function controller($scope, $service) {
        ...
        $scope.states = STATES;
        $scope.licenseTypes = LICENSE_TYPES;
        $scope.distributionTypes = DISTRIBUTION_TYPES;
