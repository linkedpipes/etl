...
public class Execution {
     ...
     * this application.
     */
    private List<Statement> executionStatementsGenerated =
    ...
    void setExecutionStatementsGenerated(
            List<Statement> executionStatementsGenerated) {
    ...
    boolean changedAfter(Date date) {
        if (status == StatusType.DANGLING ||
                status == StatusType.UNRESPONSIVE) {
